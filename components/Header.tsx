    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-[100] px-4 md:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between glass-panel rounded-full px-4 md:px-6 py-3 border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
          ...
          >
            <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-gradient-to-tr from-blue-600 to-teal-500 flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
            ...
            <span className="font-display font-bold text-lg md:text-xl text-white tracking-tight whitespace-nowrap">
